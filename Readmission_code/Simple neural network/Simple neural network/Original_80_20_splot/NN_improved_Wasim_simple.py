...
for i in tqdm(out_layers): # testing all combinations of chosen hyperparameter search space
    ...
    for j in tqdm(out_neurons):
        ...
        lr = 0.001 # set Chris original learning rate to Adam optimizer default 
        ...
        history=model_.fit([demo_train,diag_train,scripts_train,LTC_train],label_train
                            ,epochs=20,validation_data=([demo_test,diag_test,scripts_test,LTC_test], label_test),batch_size=64,callbacks=[early_stopping],verbose=1)
